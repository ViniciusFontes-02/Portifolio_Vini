    ...
    <div className="about-container">
      ...
      <div>
        ...
        <p>
          ...
          Atualmente, estou no meu terceiro semestre em Análise e
          Desenvolvimento de Sistemas. Estou sempre em busca de novos desafios e
          oportunidades para aprimorar minhas habilidades e conhecimentos.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          Telefone: <span>(11) 967519615</span>
        </p>
        ...
        <div>
          ...
          <div>
            <div>
              ...
              <p>
                Responsável pela criação de planilhas, controlei meticulosamente
                o envio e recebimento de mercadorias, bem como as rotas de
                entrega, garantindo a eficiência logística. Além disso, emiti
                notas fiscais para os produtos vendidos e recebidos, elaborando
                planilhas detalhadas para o controle de informações e realizando
                atendimentos aos clientes para resolver demandas comerciais e
                conflitos. Mantive contato direto com transportadoras para
                garantir a pontualidade das entregas e controlei os pagamentos
                dos pedidos, analisando as planilhas de comissão dos vendedores
                e preparando relatórios mensais de faturamento e premiações.
                Também conduzi conciliações bancárias e estabeleci comunicação
                efetiva com diversas áreas internas. Paralelamente, como parte
                de minhas responsabilidades, fui encarregado de criar ofertas
                inovadoras que resultaram em um aumento significativo de vendas.
                Como resultado direto dessas ações, obtivemos um impressionante
                aumento de 70% nos envios de produtos corretos e dentro do prazo
                estipulado.
              </p>
            </div>
          </div>
